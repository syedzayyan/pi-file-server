        ...
        {#if loaded}
            {#each Object.entries(data) as [_, value]}
                    ...
                    <tr>
                        ...
                        <td><a href = {"/drives/" + slug + value.filename}>{value.filename}</a></td>
                        <td><button class = "btn btn-danger" on:click = {() => {trash(value.filename)}}>Delete</button></td>
                    ...
                    <tr>
                        ...
                        <td><a href = {fileAPIPath + slug + value.filename}>{value.filename}</a></td>
                        <td><button class = "btn btn-danger" on:click = {() => {trash(value.filename)}}>Delete</button></td>
                        <td>{value.filesize}</td>
                        <td>{value.filemodtime}</td>
                    </tr>
